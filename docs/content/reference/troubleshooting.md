...
Most of these come down to network reality or how github serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

github rate-limits like any public site. ghb already paces
...
Where a surface is gated, ghb reads a cookie or token you supply
...
`ghb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ghb actually did
